...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="admin/userEdit" method="post">
		    <input type="hidden" name="id" value="${user.id}"/>
		        <label>用户名</label>
		        <input type="text" value="${user.username}" id="username" name="username" class="input-xlarge span12" readonly="readonly" required>
		        <label>姓名</label>
		        <input type="text"  value="${user.realname}" id="realname" name="realname" class="input-xlarge span12" required>
		        <label>性别</label>
		        ...
		        <label>电话</label>
		        <input type="number" value="${user.tel}" id="tel" name="tel" class="input-xlarge span12" required>
		        <label>email</label>
		        <input type="text" value="${user.email}" id="email" name="email" class="input-xlarge span12" required>
		        <label>地址</label>
		        <input type="text" value="${user.addr}" id="addr" name="addr" class="input-xlarge span12" required>
