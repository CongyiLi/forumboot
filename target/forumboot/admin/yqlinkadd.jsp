...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="<%=path %>/admin/yqlinkAdd" method="post">
		        <label>链接名称</label>
		        <input type="text" id="linkname" name="linkname" class="input-xlarge span12" required>
		        <label>链接地址</label>
		        <input type="text" id="linkurl" name="linkurl" class="input-xlarge span12" required>
