...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="<%=path %>/admin/bbstypeEdit" method="post">
		    <input type="hidden" name="id" value="${bbstype.id}">
		        <label>类别名称</label>
		        <input type="text" id="title" name="typename" value="${bbstype.typename}" class="input-xlarge span12" required>
