...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="<%=path %>/admin/newsAdd" method="post">
		        <label>标题</label>
		        <input type="text" id="title" name="title" required class="input-xlarge" oninvalid="setCustomValidity('标题不能为空')" oninput="setCustomValidity('');">
		        <label>图片</label>
