...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="<%=path %>/admin/yqlinkEdit" method="post">
		    <input type="hidden" name="id" value="${ yqlink.id}"/>
		        <label>链接名称</label>
		        <input type="text" id="linkname" name="linkname" class="input-xlarge span12" value="${yqlink.linkname}" required>
		        <label>链接地址</label>
		        <input type="text" id="linkurl" name="linkurl" class="input-xlarge span12" value="${yqlink.linkurl}" required>
