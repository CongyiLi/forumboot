...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="admin/mgwordEdit" method="post">
		    <input type="hidden" name="id" value="${mgword.id}">
		        <label>敏感字符</label>
		        <input type="text" id="wordnote" name="wordnote" class="input-xlarge span12" value="${mgword.wordnote}" required>
