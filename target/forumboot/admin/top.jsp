...
if(session.getAttribute("admin")==null){
	request.getRequestDispatcher("/forumboot/login.jsp").forward(request,response);
}
%>
                ...
                <ul class="nav pull-right">
                    ...
                    <li id="fat-menu" class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li><a tabindex="-1"  href="admin/adminShow">个人信息</a></li>
                            <li class="divider"></li>
                            <li><a tabindex="-1" href="<%=path %>/admin/adminExit">安全退出</a></li>
                        </ul>
                    </li>
