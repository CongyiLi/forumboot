	    ...
	    <div class="layui-tab layui-tab-brief" lay-filter="user">
	      <ul class="layui-tab-title" id="LAY_mine">
	        <li ><a href="myFollow">我的关注</a></li>
              <li data-type="mine-jie" lay-id="index" class="layui-this"><a href="myfans">我的粉丝</a></li>
	      </ul>
	      <div class="layui-tab-content" style="padding: 20px 0;">
	        <div class="layui-tab-item layui-show">
	          <ul class="mine-view jie-row">
	          <c:forEach items="${pageInfo.list}" var="fans">
	            <li>
	              <a class="fly-nav-avatar" href="javascript:;">
	         
	          <!--<i class="layui-badge fly-badge-vip layui-hide-xs">VIP3</i>-->
	          <img src="<%=path %>/upload/${fans.member.filename}">
	        </a>
	              <a class="jie-title" href="Home?memberid=${fans.member.id}">${fans.member.tname}</a>
	            </li>
	            </c:forEach>
	          </ul>
